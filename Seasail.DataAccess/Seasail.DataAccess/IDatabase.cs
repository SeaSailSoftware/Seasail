...
namespace Seasail.DataAccess
{
    public interface IDatabase
    {
        ...
        Task<int> DeleteById<T>(dynamic id) where T : class;
        Task<int> DeleteByIds<T>(dynamic[] ids) where T : class;
        Task<int> Delete<T>(string propertyName, dynamic propertyValue) where T : class;
